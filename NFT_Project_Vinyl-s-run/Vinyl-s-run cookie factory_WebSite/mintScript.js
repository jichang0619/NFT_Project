...
let picnum = 1; // index.html 에서 입력에 따라 바뀔 수 있는 line 추가 필요
...
async function check_status() {
    if (picnum==1){
        ...
        myContract = new caver.klay.Contract(ABI, CONTRACTADDRESS2);
    }
    else {
        myContract = new caver.klay.Contract(ABI, CONTRACTADDRESS3);
    }
